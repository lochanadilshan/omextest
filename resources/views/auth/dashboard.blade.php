...
<div class="text-center col-md-10 col-6">
<img src="{{asset('assets/img/yu.png')}}" height="150" width="250">
<h3 class="login-heading mb-4" align="center">Welcome {{ ucfirst(Auth()->user()->name) }}!</h3>
</div>

{{-- calender --}}
<div class="card bg-gradient-primary col-md-2">
...
<section>
  ...
  <div class="container-fluid ">
    ...
    {{-- Latest Orders --}}
    <div class="card col-md-12 bg-gradient-light">
        ...
        <div class="table-responsive">
          <table class="table m-0">
            ...
            <tr>
              ...
              <td>Corsair 8GB Ram</td>
              <td><span class="badge badge-warning">Pending</span></td>
      
            </tr>
            <tr>
              <td><a href="pages/examples/invoice.html">OR7429</a></td>
              <td>Asus GTX 960 2GB Graphic Card</td>
